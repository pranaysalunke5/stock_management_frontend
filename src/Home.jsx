...
const Home = () => {
  ...
  // const addProduct = () => {
  //   const obj = []
  //   setSelectedOption([...selectedOption,obj])
  //   setShowPopup(false)
  // }
                ...
                {/* {options.map((product, index) => ( */}
                  ...
                  //  key={index} 
                   className="bg-white border-b  ">
                    ...
                    <td class="px-6 py-4 text-gray-900 "> type</td>
                <td class="px-6 py-4 text-gray-900 ">unit</td>
                <td class="px-6 py-4 text-gray-900 ">price</td>
                    {/* <td className="px-6 py-4 text-gray-900 ">{product.sku} sku</td>
                    <td class="px-6 py-4 text-gray-900 ">{product.type} type</td>
                <td class="px-6 py-4 text-gray-900 ">{product.unit} unit</td>
                <td class="px-6 py-4 text-gray-900 ">{product.basePrice} price</td> */}
                <td class="flex items-center px-6 py-4">
                  <a
                    href="#"
                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
